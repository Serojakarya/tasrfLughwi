...
function loadSurah(ChapterSurah){
    ...
    var chapter = ChapterSurah;
            ...
            var scriptData = '<script>$(function(){var hash = window.location.hash;if(hash){window.location.href = hash;}var e=audiojs.createAll({trackEnded:function(){var e=$("#ok .c.playing").next();if(!e.length)e=$("#ok .c").first();e.addClass("playing").siblings().removeClass("playing");$("html,body").animate({scrollTop: e.offset().top}, 500);t.load($("a",e).attr("data-src"));t.play()}});var t=e[0];first=$("#ok a").attr("data-src");$("#ok .c").first().addClass("playing");t.load(first);$("#ok .c").click(function(e){e.preventDefault();$(this).addClass("playing").siblings().removeClass("playing");$("html,body").animate({scrollTop: $(this).offset().top}, 500);t.load($("a",this).attr("data-src"));t.play()});$(document).keydown(function(e){var n=e.charCode?e.charCode:e.keyCode;if(n==39){var r=$(".c.playing").next();if(!r.length)r=$("#ok .c").first();r.click()}else if(n==37){var i=$(".c.playing").prev();if(!i.length)i=$("#ok .c").last();i.click()}else if(n==32){t.playPause()}})})</script>';
    ...
    // here, do what ever you want
                 ...
                 //   $.getJSON('./json/surah/surah_' + chapter + '.json', function (quran) {
                    //    $.getJSON('./json/translation/id/id_translation_' + chapter + '.json', function (trans) {
				            ...
				            var scriptData = '<script>$(function(){var e=audiojs.createAll({trackEnded:function(){var e=$("#ok .c.playing").next();if(!e.length)e=$("#ok .c").first();e.addClass("playing").siblings().removeClass("playing");$("html,body").animate({scrollTop: e.offset().top}, 500);t.load($("a",e).attr("data-src"));t.play()}});var t=e[0];first=$("#ok a").attr("data-src");$("#ok .c").first().addClass("playing");t.load(first);$("#ok .c").click(function(e){e.preventDefault();$(this).addClass("playing").siblings().removeClass("playing");$("html,body").animate({scrollTop: $(this).offset().top}, 500);t.load($("a",this).attr("data-src"));t.play()});$(document).keydown(function(e){var n=e.charCode?e.charCode:e.keyCode;if(n==39){var r=$(".c.playing").next();if(!r.length)r=$("#ok .c").first();r.click()}else if(n==37){var i=$(".c.playing").prev();if(!i.length)i=$("#ok .c").last();i.click()}else if(n==32){t.playPause()}})})</script>';
				            $top.append(scriptData);
                   //     });
                  //  });
                })(i, j);
